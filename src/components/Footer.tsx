...
export default function Footer() {
  return (
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-surface)] no-print">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-[var(--color-text-muted)] mt-2 max-w-sm leading-relaxed">
              Create QR product passports for small brands. Organize product data, generate public passport pages, and prepare for product transparency requirements.
            </p>
          </div>
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-[var(--color-text-muted)] mb-3">Product</h4>
            <div className="flex flex-col gap-1.5">
              <Link href="/generator" className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-text)] no-underline transition-colors">Generator</Link>
